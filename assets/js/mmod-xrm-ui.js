...
(   // When a mouse move is detected (it means a mouse has entered the elements area)
    function(e)
    {
        ...
        if( ( preX === false ) || ( preY === false ) )
        {
            ...
            var originals = mQuery( this ).css( "background-position" ).split(" ");
        ...
        mQuery( this ).css( 'background-position', nX + '% ' + nY + 'px' );
...
jQuery( '.jumbotron' ).mouseout
(
    function( e )
    {
        mQuery( this ).css( 'background-position', oX + ' ' + oY );
    }
);
